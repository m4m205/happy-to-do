...
describe("ItemComponent elements", () => {
  it("renders properly", () => {
    ...
    expect(wrapper.findAll('i')[0].classes()).toContain('bi-check-circle-fill', 'text-success')
    expect(wrapper.findAll('i')[1].classes()).toContain('bi-trash3-fill', 'text-danger')
    expect(wrapper.findAll('i')[2].classes()).toContain('bi-info-circle', 'text-info')
